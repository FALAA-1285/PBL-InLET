...
CREATE TABLE IF NOT EXISTS public.peminjaman (
    ...
    CONSTRAINT chk_waktu_logical CHECK (
        (tanggal_pinjam IS NULL)
        OR (tanggal_kembali IS NULL)
        OR (
            (waktu_pinjam IS NULL)
            OR (waktu_kembali IS NULL)
        )
        OR (
...
ALTER TABLE
    public.absensi DROP CONSTRAINT IF EXISTS fk_absensi_mahasiswa;

ALTER TABLE
    public.absensi
ADD
    CONSTRAINT fk_absensi_mahasiswa FOREIGN KEY (id_mhs) REFERENCES public.mahasiswa(id_mahasiswa) ON DELETE RESTRICT;

-- Alat Lab foreign keys
ALTER TABLE
    public.alat_lab DROP CONSTRAINT IF EXISTS fk_alatlab_admin;

ALTER TABLE
    public.alat_lab
ADD
    CONSTRAINT fk_alatlab_admin FOREIGN KEY (id_admin) REFERENCES public.admin(id_admin) ON UPDATE CASCADE ON DELETE RESTRICT;

-- Berita foreign keys
ALTER TABLE
    public.berita DROP CONSTRAINT IF EXISTS fk_berita_admin;

ALTER TABLE
    public.berita
ADD
    CONSTRAINT fk_berita_admin FOREIGN KEY (id_admin) REFERENCES public.admin(id_admin) ON DELETE
SET
    NULL;

-- Gallery foreign keys
ALTER TABLE
    public.gallery DROP CONSTRAINT IF EXISTS fk_gallery_berita;

ALTER TABLE
    public.gallery
ADD
    CONSTRAINT fk_gallery_berita FOREIGN KEY (id_berita) REFERENCES public.berita(id_berita) ON UPDATE CASCADE ON DELETE CASCADE;

-- Mahasiswa foreign keys
ALTER TABLE
    public.mahasiswa DROP CONSTRAINT IF EXISTS fk_mahasiswa_admin;

ALTER TABLE
    public.mahasiswa
ADD
    CONSTRAINT fk_mahasiswa_admin FOREIGN KEY (id_admin) REFERENCES public.admin(id_admin) ON UPDATE CASCADE ON DELETE
SET
    NULL;

-- Member foreign keys
ALTER TABLE
    public.member DROP CONSTRAINT IF EXISTS fk_member_admin;

ALTER TABLE
    public.member
ADD
    CONSTRAINT fk_member_admin FOREIGN KEY (id_admin) REFERENCES public.admin(id_admin) ON UPDATE CASCADE ON DELETE
SET
    NULL;

-- Peminjaman foreign keys
ALTER TABLE
    public.peminjaman DROP CONSTRAINT IF EXISTS fk_peminjaman_alat;

ALTER TABLE
    public.peminjaman
ADD
    CONSTRAINT fk_peminjaman_alat FOREIGN KEY (id_alat) REFERENCES public.alat_lab(id_alat_lab) ON UPDATE CASCADE ON DELETE RESTRICT;

ALTER TABLE
    public.peminjaman DROP CONSTRAINT IF EXISTS fk_peminjaman_ruang;

ALTER TABLE
    public.peminjaman
ADD
    CONSTRAINT fk_peminjaman_ruang FOREIGN KEY (id_ruang) REFERENCES public.ruang_lab(id_ruang_lab) ON UPDATE CASCADE ON DELETE RESTRICT;

-- Penelitian foreign keys
ALTER TABLE
    public.penelitian DROP CONSTRAINT IF EXISTS fk_penelitian_fokus;

ALTER TABLE
    public.penelitian
ADD
    CONSTRAINT fk_penelitian_fokus FOREIGN KEY (id_fp) REFERENCES public.fokus_penelitian(id_fp) ON UPDATE CASCADE ON DELETE
SET
    NULL;

ALTER TABLE
    public.penelitian DROP CONSTRAINT IF EXISTS fk_penelitian_mitra;

ALTER TABLE
    public.penelitian
ADD
    CONSTRAINT fk_penelitian_mitra FOREIGN KEY (id_mitra) REFERENCES public.mitra(id_mitra) ON DELETE
SET
    NULL;

ALTER TABLE
    public.penelitian DROP CONSTRAINT IF EXISTS fk_penelitian_produk;

ALTER TABLE
    public.penelitian
ADD
    CONSTRAINT fk_penelitian_produk FOREIGN KEY (id_produk) REFERENCES public.produk(id_produk) ON DELETE
SET
    NULL;

ALTER TABLE
    public.penelitian DROP CONSTRAINT IF EXISTS progress_id_artikel_fkey;

ALTER TABLE
    public.penelitian
ADD
    CONSTRAINT progress_id_artikel_fkey FOREIGN KEY (id_artikel) REFERENCES public.artikel(id_artikel) ON DELETE
SET
    NULL;

ALTER TABLE
    public.penelitian DROP CONSTRAINT IF EXISTS progress_id_member_fkey;

ALTER TABLE
    public.penelitian
ADD
    CONSTRAINT progress_id_member_fkey FOREIGN KEY (id_member) REFERENCES public.member(id_member) ON DELETE
SET
    NULL;

ALTER TABLE
    public.penelitian DROP CONSTRAINT IF EXISTS progress_id_mhs_fkey;

ALTER TABLE
    public.penelitian
ADD
    CONSTRAINT progress_id_mhs_fkey FOREIGN KEY (id_mhs) REFERENCES public.mahasiswa(id_mahasiswa) ON DELETE
SET
    NULL;

-- Ruang Lab foreign keys
ALTER TABLE
    public.ruang_lab DROP CONSTRAINT IF EXISTS fk_ruang_admin;

ALTER TABLE
    public.ruang_lab
ADD
    CONSTRAINT fk_ruang_admin FOREIGN KEY (id_admin) REFERENCES public.admin(id_admin) ON UPDATE CASCADE ON DELETE
SET
    NULL;

-- Settings foreign keys
ALTER TABLE
    public.settings DROP CONSTRAINT IF EXISTS fk_settings_admin;

ALTER TABLE
    public.settings
ADD
    CONSTRAINT fk_settings_admin FOREIGN KEY (updated_by) REFERENCES public.admin(id_admin) ON UPDATE CASCADE ON DELETE RESTRICT;

-- Visitor foreign keys
ALTER TABLE
    public.visitor DROP CONSTRAINT IF EXISTS visitor_id_pengunjung_fkey;

ALTER TABLE
    public.visitor
ADD
    CONSTRAINT visitor_id_pengunjung_fkey FOREIGN KEY (id_pengunjung) REFERENCES public.pengunjung(id_pengunjung) ON DELETE CASCADE;
...
CREATE
OR REPLACE VIEW public.view_alat_dipinjam AS
SELECT
    alat.id_alat_lab,
    alat.nama_alat,
    alat.stock,
...
DO $ $ BEGIN RAISE NOTICE 'InLET PBL Database setup completed successfully!';
